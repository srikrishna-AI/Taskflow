  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-2 mb-8 relative">
        ...
        <h2 className="text-2xl font-bold font-display tracking-tight text-slate-850 dark:text-white">Create your account</h2>
        <p className="text-xs text-slate-400 dark:text-slate-500">Sign up to start organizing tasks with TaskFlow</p>
      </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2.5 w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-55/50 dark:bg-slate-950/60 text-xs outline-none focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900 transition-all text-slate-805 dark:text-white"
              required
            />
          </div>
        </div>
